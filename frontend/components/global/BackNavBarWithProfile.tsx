...
export const BackNavBarWithProfile = ({
  title,
  showProfilePic = true,
  ...
  return (
    <View
      style={[
        styles.container,
        showProfilePic && { justifyContent: "space-between" },
      ]}
    >
      <TouchableOpacity
